...
class CustomKeywords {
	...
	@Keyword
	def verifyGlobalVar(TestObject request, String actual, String expected){
		if (actual.matches(expected)) {
			KeywordUtil.markPassed("Global Variable matches successfully")
		}
	}
